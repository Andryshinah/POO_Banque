...
<div class="card bg-secondary mb-3 " style="max-width: 20rem;margin: 70px 100px 100px 458px;">
  ...
  <div class="card-body">
    <form method='POST' action='ClientInsertData'>
    <p class="card-text">
    ...
    <div class="form-group">
        <label class="col-form-label mt-4" for="inputDefault">Numero CIN</label>
        <input type="text" name="NumCompte" class="form-control">
    </div>
    <button type="submit" class="btn btn-primary" name='submit' style= "margin: 5% 10% 10% 24%;">Creer un Compte</button>
</form>
</body>
</html>